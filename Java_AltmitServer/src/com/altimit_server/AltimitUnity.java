...
public class AltimitUnity {
    ...
    public static void RegisterSceneObject(Integer viewId, UUID clientUUID){
        UnityObject temp = new UnityObject(viewId);
        Rooms.AddSceneUnityObject(Users.GetRoomName(clientUUID), temp);
        System.out.println("Added a scene object");
    }
